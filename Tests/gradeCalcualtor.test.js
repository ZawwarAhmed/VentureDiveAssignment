const getGrade = require("../Tasks/GradeAssignment")
...
test("If score is less than 0 or greter than 100, then it should prompt 'Score should be between 0 and 100.'", () => {
    expect(getGrade(103)).toBe("Score should be between 0 and 100.")
})